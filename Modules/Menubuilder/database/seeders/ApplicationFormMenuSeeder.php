...
class ApplicationFormMenuSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        if ($navMenu) {
            ...
            $this->command->info('Application Form menu item added successfully!');
        } else {
            $this->command->error('Navigation menu not found!');
        }
    }
}
