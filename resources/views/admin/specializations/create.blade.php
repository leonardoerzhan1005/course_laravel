...
@section('title', __('Добавить специализацию'))
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title">{{ __('Добавить специализацию') }}</h4>
                                    ...
                                    <select class="form-control @error('faculty_id') is-invalid @enderror" 
                                        ...
                                        @foreach($faculties as $faculty)
                                            <option value="{{ $faculty->id }}" 
                                                    {{ old('faculty_id', request('faculty_id')) == $faculty->id ? 'selected' : '' }}>
                                                {{ $faculty->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="is_active" name="is_active" 
                                               value="true" {{ old('is_active', true) ? 'checked' : '' }}>
