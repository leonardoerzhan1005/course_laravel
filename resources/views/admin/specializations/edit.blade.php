...
@section('title', __('Редактировать специализацию'))
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title">{{ __('Редактировать специализацию') }}</h4>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="faculty_id" class="form-label">{{ __('Направление курса') }} *</label>
                                    <select class="form-control @error('faculty_id') is-invalid @enderror" 
                                        ...
                                        @foreach($faculties as $faculty)
                                            <option value="{{ $faculty->id }}" 
                                                    {{ old('faculty_id', $specialization->faculty_id) == $faculty->id ? 'selected' : '' }}>
                                                {{ $faculty->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name_ru') is-invalid @enderror" 
                                           id="name_ru" name="name_ru" value="{{ old('name_ru', $specialization->name_ru) }}" required>
                                    @error('name_ru')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name_kz') is-invalid @enderror" 
                                           id="name_kz" name="name_kz" value="{{ old('name_kz', $specialization->name_kz) }}">
                                    @error('name_kz')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name_en') is-invalid @enderror" 
                                           id="name_en" name="name_en" value="{{ old('name_en', $specialization->name_en) }}">
                                    @error('name_en')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="is_active" name="is_active" 
                                               value="true" {{ old('is_active', $specialization->is_active) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="is_active">
                                            {{ __('Активна') }}
                                        </label>
                                    </div>
                                    <small class="form-text text-muted">{{ __('Активные специализации отображаются в формах') }}</small>
                                </div>
                            </div>
                        </div>
