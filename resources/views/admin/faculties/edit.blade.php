...
@section('title', __('Редактировать направление курса'))
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title">{{ __('Редактировать направление курса') }}</h4>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name_ru') is-invalid @enderror" 
                                           id="name_ru" name="name_ru" value="{{ old('name_ru', $faculty->name_ru) }}" required>
                                    @error('name_ru')
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name_kz') is-invalid @enderror" 
                                           id="name_kz" name="name_kz" value="{{ old('name_kz', $faculty->name_kz) }}">
                                    @error('name_kz')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
