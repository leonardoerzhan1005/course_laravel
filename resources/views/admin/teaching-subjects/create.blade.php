...
@section('title')
    <title>{{ __('Добавить предмет') }}</title>
@endsection
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">{{ __('Добавить предмет') }}</div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>{{ __('Новый предмет') }}</h4>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('admin.teaching-subjects.store') }}" method="POST">
                                    @csrf
