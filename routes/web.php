...
use App\Http\Controllers\Frontend\DocumentsController;
use App\Http\Controllers\Frontend\CertificatesController;
...
Route::group(['middleware' => 'maintenance.mode'], function () {
    ...
    /** Certificates page routes */
    Route::get('certificates', [CertificatesController::class, 'index'])->name('certificates');
    Route::post('certificates/search', [CertificatesController::class, 'search'])->name('certificates.search');
    /** Contact page routes */
